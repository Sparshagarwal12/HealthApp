...
public class Labs_CheckboxAdapter extends RecyclerView.Adapter<Labs_CheckboxAdapter.CheckboxViewHolder> {
    ...
    public Labs_CheckboxAdapter(Context mCtx, List<String> checkList) {
        this.mCtx = mCtx;
    ...
    public CheckboxViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        view = inflater.inflate(R.layout.labs_checkbox, null);
...
//            cb.setChecked(true);
        ...
        holder.addBtn_labs.setOnClickListener(new OnClickListener() {
            @Override
...
//                                  cb.setChecked(true);
        ...
        holder.submit_labs.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
...
//            return checkList.size();
    ...
    class CheckboxViewHolder extends RecyclerView.ViewHolder {
        ...
        public CheckboxViewHolder(@NonNull View itemView) {
            super(itemView);
            linearLayout  = itemView.findViewById(R.id.labs_layout);
            addBtn_labs = itemView.findViewById(R.id.addBtn_labs);
            submit_labs = itemView.findViewById(R.id.submit_labs);
        }
    }
}
