...
public class Ward_CheckboxAdapter extends RecyclerView.Adapter<Ward_CheckboxAdapter.CheckboxViewHolder> {
        ...
        public Ward_CheckboxAdapter(Context mCtx, List<String> checkList) {
            this.mCtx = mCtx;
        ...
        public CheckboxViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            LayoutInflater inflater = LayoutInflater.from(mCtx);
                view = inflater.inflate(R.layout.ward_checkboxes, null);
...
//            return checkList.size();
        ...
        class CheckboxViewHolder extends RecyclerView.ViewHolder {
            ...
            public CheckboxViewHolder(@NonNull View itemView) {
                super(itemView);
               linearLayout  = itemView.findViewById(R.id.ward_layout);
                addBtn = itemView.findViewById(R.id.addBtn_ward);
