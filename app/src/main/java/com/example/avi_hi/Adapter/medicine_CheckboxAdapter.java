...
public class medicine_CheckboxAdapter extends RecyclerView.Adapter<medicine_CheckboxAdapter.CheckboxViewHolder> {
    ...
    public medicine_CheckboxAdapter(Context mCtx, List<String> checkList) {
        this.mCtx = mCtx;
    ...
    public CheckboxViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        view = inflater.inflate(R.layout.medicine_checkbox, null);
...
//            cb.setChecked(true);
        ...
        holder.addBtn_medicine.setOnClickListener(new OnClickListener() {
            @Override
...
//                                  cb.setChecked(true);
        ...
        holder.submit_medicine.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
...
//            return checkList.size();
    ...
    class CheckboxViewHolder extends RecyclerView.ViewHolder {
        ...
        Button submit_medicine;
        Button addBtn_medicine;

        public CheckboxViewHolder(@NonNull View itemView) {
            super(itemView);
            linearLayout  = itemView.findViewById(R.id.medicine_layout);
            addBtn_medicine= itemView.findViewById(R.id.addBtn_medicine);
            submit_medicine= itemView.findViewById(R.id.submit_medicine);
        }
    }
}
