...
public class test_CheckboxAdapter extends RecyclerView.Adapter<test_CheckboxAdapter.CheckboxViewHolder> {
    ...
    public test_CheckboxAdapter(Context mCtx, List<String> checkList) {
        this.mCtx = mCtx;
    ...
    public CheckboxViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        view = inflater.inflate(R.layout.test_checkboxes, null);
...
//            cb.setChecked(true);
        ...
        holder.addBtn_test.setOnClickListener(new OnClickListener() {
            @Override
...
//                                  cb.setChecked(true);
        ...
        holder.submit_test.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                for (CheckBox item : checkboxList){
                    ...
                    for(final String checkedItem : items){
                        FirebaseDatabase.getInstance().getReference("hospital")
                                .child("Test_details/"+checkedItem)
...
//            return checkList.size();
    ...
    class CheckboxViewHolder extends RecyclerView.ViewHolder {
        ...
        public CheckboxViewHolder(@NonNull View itemView) {
            super(itemView);
            linearLayout  = itemView.findViewById(R.id.test_layout);
            addBtn_test = itemView.findViewById(R.id.addBtn_test);
            submit_test= itemView.findViewById(R.id.submit_test);
        }
    }
}
