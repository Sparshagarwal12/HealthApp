...
public class tika_CheckboxAdapter extends RecyclerView.Adapter<tika_CheckboxAdapter.CheckboxViewHolder> {
    ...
    public tika_CheckboxAdapter(Context mCtx, List<String> checkList) {
        this.mCtx = mCtx;
    ...
    public CheckboxViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        view = inflater.inflate(R.layout.tika_checkbox, null);
...
//            cb.setChecked(true);
        ...
        holder.addBtn_tika.setOnClickListener(new OnClickListener() {
            @Override
...
//                                  cb.setChecked(true);
        ...
        holder.submit_tika.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
...
//            return checkList.size();
    ...
    class CheckboxViewHolder extends RecyclerView.ViewHolder {
        ...
        public CheckboxViewHolder(@NonNull View itemView) {
            super(itemView);
            linearLayout  = itemView.findViewById(R.id.tika_layout);
            addBtn_tika = itemView.findViewById(R.id.addBtn_tika);
            submit_tika= itemView.findViewById(R.id.submit_tika);
        }
    }
}
