...
import com.example.avi_hi.Adapter.doctorDetailAdapater;
...
public class doctordetailshow extends AppCompatActivity implements doctorDetailAdapater.OnItemClickListener{


    public static final String name_1 = "namekhb";
    public static final String org_1 = "ortg";
    public static final String doctor_1 = "doctor";
    public static final String aadhar_1 = "aadhar";
    public static final String type_1 = "type";
    public static final String spec_1 = "spec";
    public static final String address_1 = "adljbd";
    public static final String state_1 = "stat";
    public static final String district_1 = "dis";
    public static final String pincode_1 = "pin";
    ...
    ArrayList<DoctorPostPojo> doctor_pojo = new ArrayList<>();
    private doctorDetailAdapater doctorDetailAdapaters;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doctordetailshow);

        state = findViewById(R.id.find_state);
        district = findViewById(R.id.find_district);
        recyclerView = findViewById(R.id.recycle2);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        getDoctorDetails();

        ArrayAdapter<String> dataAdapter = new ArrayAdapter<>(doctordetailshow.this, android.R.layout.simple_spinner_item, states);
        ...
        state.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ArrayAdapter<String> dataAdapter = new ArrayAdapter<>(doctordetailshow.this, android.R.layout.simple_spinner_item, districts.get(position));
    ...
    private void getDoctorDetails(){
        ...
        Call<List<DoctorPostPojo>> call = RetrofitClient.getInstance()
                .getInterface().getdoctorDetail();
        call.enqueue(new Callback<List<DoctorPostPojo>>() {
            @Override
            public void onResponse(Call<List<DoctorPostPojo>> call, Response<List<DoctorPostPojo>> response) {

                doctor_pojo = new ArrayList<>(response.body());
                doctorDetailAdapaters = new doctorDetailAdapater(doctordetailshow.this, doctor_pojo);
                recyclerView.setAdapter(doctorDetailAdapaters);
                doctorDetailAdapaters.setOnItemClickListener(doctordetailshow.this);

            }
            @Override
            public void onFailure(Call<List<DoctorPostPojo>> call, Throwable t) {
    ...
    public void onItemClick(int position) {
        ...
        Intent intent = new Intent(doctordetailshow.this, Doctor_show_detail.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        DoctorPostPojo clickedItem = doctor_pojo.get(position);
        Toast.makeText(getApplicationContext(),clickedItem.getDoctor(),Toast.LENGTH_SHORT).show();

        intent.putExtra(name_1,clickedItem.getName());
        intent.putExtra(org_1,clickedItem.getOrg());
        intent.putExtra(doctor_1,clickedItem.getDoctor());
        intent.putExtra(aadhar_1,clickedItem.getAadhar());
        intent.putExtra(type_1,clickedItem.getType());
        intent.putExtra(spec_1,clickedItem.getSpec());
        intent.putExtra(address_1,clickedItem.getAddress());
        intent.putExtra(state_1,clickedItem.getState());
        intent.putExtra(district_1,clickedItem.getDistric());
        intent.putExtra(pincode_1,clickedItem.getPincode());
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                doctorDetailAdapaters.getFilter().filter(newText);
                return false;
            }
        });
        return true;
