...
public class hospital_reg extends AppCompatActivity implements AdapterView.OnItemSelectedListener{

    EditText email1, adhar, opt_name, hos_name, opt_mobile, hos_tehsil, password,hospital_region,verify,get_id,staff_type;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        verify_button = findViewById(R.id.send_verify);
//        staff_type = findViewById(R.id.text_staff);

        state = findViewById(R.id.hospital_state);
        district = findViewById(R.id.hospital_dist);
        ArrayAdapter<String> dataAdapter = new ArrayAdapter<>(hospital_reg.this, android.R.layout.simple_spinner_item, states);
        ...
        state.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ArrayAdapter<String> dataAdapter = new ArrayAdapter<>(hospital_reg.this, android.R.layout.simple_spinner_item, districts.get(position));
...
//                dt = position;
        ...
        locate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                fusedLocationProviderClient = LocationServices.getFusedLocationProviderClient(hospital_reg.this);
                fetchLastLocation();
            }
        });
        ...
        hos_name = findViewById(R.id.hospital_name);
        opt_name = findViewById(R.id.operator_Name);
        adhar = findViewById(R.id.operator_aadhar);
        get_id = findViewById(R.id.staff_id);
        opt_mobile = findViewById(R.id.operator_mobile);
        password = findViewById(R.id.hospital_password);
        hos_tehsil= findViewById(R.id.hospital_tehsil);
        hospital_region = findViewById(R.id.hospital_region);
        submit = findViewById(R.id.button_submit_hospital);
    ...
    private void hospital_register(){

        String hospital_operator_aadhar =adhar.getText().toString().trim();
        String hospital_password = password.getText().toString().trim();
        String hospital_email = email1.getText().toString().trim();
        String hospital_name = hos_name.getText().toString().trim();
        String hospital_tehsil = hos_tehsil.getText().toString().trim();
        String hospital_latitude = lat1.getText().toString().trim();
        String hospital_longitude = lont.getText().toString().trim();
        String hospital_mobile= opt_mobile.getText().toString().trim();
        ...
        String hospital_id = get_id.getText().toString().trim();
//        String hospital_staff = staff_type.getText.toString().trim;
        Call<ResponseBody> call= RetrofitClient.getInstance()
                .getInterface()
                .createHospital(
                      hospital_operator_aadhar,
                        hospital_password,
                        hospital_email,
                        hospital_name,
                        hospital_tehsil,
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
               ...
               // Toast.makeText(hospital_reg.this,"User Created Successfully",Toast.LENGTH_LONG).show();
                try {
                    ...
                    Toast.makeText(hospital_reg.this,"User Created Successfully"+s,Toast.LENGTH_LONG).show();
                    Intent intent = new Intent(hospital_reg.this, hospital_login.class);
