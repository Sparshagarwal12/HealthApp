...
public class ambulance_checkbox extends RecyclerView.Adapter<ambulance_checkbox.CheckboxViewHolder> {
    ...
    public ambulance_checkbox(Context mCtx, List<String> checkList) {
        this.mCtx = mCtx;
    ...
    public CheckboxViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        view = inflater.inflate(R.layout.ambulance_checkbox, null);
...
//            cb.setChecked(true);
        ...
        holder.addBtn_ambulance.setOnClickListener(new OnClickListener() {
            @Override
...
//                                  cb.setChecked(true);
        ...
        holder.submit_ambulance.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                for (CheckBox item : checkboxList){
                    ...
                    for(final String checkedItem : items){
                        FirebaseDatabase.getInstance().getReference("ambulance/"+checkedItem)
...
//            return checkList.size();
    ...
    class CheckboxViewHolder extends RecyclerView.ViewHolder {
        ...
        Button submit_ambulance;
        Button addBtn_ambulance;

        public CheckboxViewHolder(@NonNull View itemView) {
            super(itemView);
            linearLayout  = itemView.findViewById(R.id.ambulance_layout);
            addBtn_ambulance= itemView.findViewById(R.id.addBtn_ambulance);
            submit_ambulance= itemView.findViewById(R.id.submit_ambulance);
        }
    }
}
